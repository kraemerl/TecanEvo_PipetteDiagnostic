...
namespace TecanEvo_PipetteDiagnostic
{
    public partial class ScanReport : Form
    {
        ...
        /// 
        /// scan_report C:\Lars\Git\C#_projects\TecanEvo_PipetteDiagnostic\Data\variables.csv C:\Lars\Git\C#_projects\TecanEvo_PipetteDiagnostic\Data\source_eppi_barcode.csv C:\Lars\Git\C#_projects\TecanEvo_PipetteDiagnostic\Data\lastJobInfo.txt C:\Lars\Git\C#_projects\TecanEvo_PipetteDiagnostic\Data\worklist.gwl
        /// </summary>
        ...
        private Boolean writeWorklistFile(string file)
        {
            ...
            try
            {
                ...
                using (var streamWriter = new StreamWriter(fileStream))
                {
                    ...
                    streamWriter.WriteLine("C; This GWL was generated by TecanEvo_PipetteDiagnostic at " + localDate);
                    ...
                    if (m_normalize == 1)
                    {
                            ...
                            if (sourceBarcodesDict[key].getSource() == "DW96well")
                            {
                                ...
                                if (volume > 0)
                                {
                                    if (volume <= maxAspirate)
                                    {
                                        ...
                                        streamWriter.WriteLine("D;DW96well;;Deepwell 0.8 mL;" + sourceBarcodesDict[key].getRackPos() + ";;" + volume.ToString("R", CultureInfo.InvariantCulture) + ";DNA Transfer Job Buffer;;" + Convert.ToInt16(Math.Pow(2, tip)) + ";;;");
                                    ...
                                    else
                                    {
                                        ...
                                        while (readwriteVolume > 0)
                                        {
                                            ...
                                            streamWriter.WriteLine("D;DW96well;;Deepwell 0.8 mL;" + sourceBarcodesDict[key].getRackPos() + ";;" + actPipetVolume.ToString("R", CultureInfo.InvariantCulture) + ";DNA Transfer Job Buffer;;" + Convert.ToInt16(Math.Pow(2, tip)) + ";;;");
                        ...
                        foreach (string key in destinationWellDict.Keys)
                        {
                            ...
                            if (volume > 0)
                            {
                                ...
                                {
                                    streamWriter.WriteLine("A;Buffer;;Trough 100ml;" + (tip + 1) + ";;" + volume.ToString("R", CultureInfo.InvariantCulture) + ";DNA Transfer Job Buffer;;" + Convert.ToInt16(Math.Pow(2, tip)) + ";;;");
                                    streamWriter.WriteLine("D;PCR96well;;96 well PCR in Metalladapter;" + RackPosTo96wellNumber(key) + ";;" + volume.ToString("R", CultureInfo.InvariantCulture) + ";DNA Transfer Job Buffer;;" + Convert.ToInt16(Math.Pow(2, tip)) + ";;;");
                                    streamWriter.WriteLine("W3;");
                                }
                                else
                                {
                                    ...
                                    {
                                        streamWriter.WriteLine("A;Buffer;;Trough 100ml;" + (tip + 1) + ";;" + actPipetVolume.ToString("R", CultureInfo.InvariantCulture) + ";DNA Transfer Job Buffer;;" + Convert.ToInt16(Math.Pow(2, tip)) + ";;;");
                                        streamWriter.WriteLine("D;PCR96well;;96 well PCR in Metalladapter;" + RackPosTo96wellNumber(key) + ";;" + actPipetVolume.ToString("R", CultureInfo.InvariantCulture) + ";DNA Transfer Job Buffer;;" + Convert.ToInt16(Math.Pow(2, tip)) + ";;;");
                                        readwriteVolume -= actPipetVolume;
                                        if (readwriteVolume > maxAspirate)
                                            actPipetVolume = maxAspirate;
                                        else
                    ...
                    foreach (string key in sourceBarcodesDict.Keys)
                    {
                        if (sourceBarcodesDict[key].getSource() == "DW96well")
                        {
                            ...
                            if (volume <= maxAspirate)
                            {
                                ...
                                {
                                    streamWriter.WriteLine("A;" + sourceBarcodesDict[sourceBarcodesDict[key].getBarcode()].getEppieRack() + ";;" + sourceLabwareType + ";" + sourceBarcodesDict[sourceBarcodesDict[key].getBarcode()].getRackPos() + ";;" + volume.ToString("R", CultureInfo.InvariantCulture) + ";DNA slow dispense;;" + Convert.ToInt16(Math.Pow(2, tip)) + ";;;");
                                }
                                else
                                {
                                    streamWriter.WriteLine("A;" + sourceLabwareName + ";;" + sourceLabwareType + ";" + sourceBarcodesDict[sourceBarcodesDict[key].getBarcode()].getRackPos() + ";;" + volume.ToString("R", CultureInfo.InvariantCulture) + ";DNA slow dispense;;" + Convert.ToInt16(Math.Pow(2, tip)) + ";;;");
                                }
                                streamWriter.WriteLine("D;DW96well;;Deepwell 0.8 mL;" + sourceBarcodesDict[key].getRackPos() + ";;" + volume.ToString("R", CultureInfo.InvariantCulture) + ";DNA slow dispense;;" + Convert.ToInt16(Math.Pow(2, tip)) + ";;;");
                            }
                            else
                            {
                                double readwriteVolume = volume;
                            ...
                            streamWriter.WriteLine("A;DW96well;;Deepwell 0.8 mL;" + sourceBarcodesDict[key].getRackPos() + ";;" + mixVolume + ";DNA slow dispense;;" + Convert.ToInt16(Math.Pow(2, tip)) + ";;;");
                            streamWriter.WriteLine("D;DW96well;;Deepwell 0.8 mL;" + sourceBarcodesDict[key].getRackPos() + ";;" + mixVolume + ";DNA slow dispense;;" + Convert.ToInt16(Math.Pow(2, tip)) + ";;;");
                    ...
                    foreach (string key in destinationWellDict.Keys)
                    {
                        if (destinationWellDict[key].getSampleBarcode() != "NC")
                        {
                            ...
                            if (volume <= maxAspirate)
                            {
                                if (sourceLabwareName == "Eppi 2ml")
                                {
                                    streamWriter.WriteLine("A;" + sourceBarcodesDict[destinationWellDict[key].getSampleBarcode()].getEppieRack() + ";;" + sourceLabwareType + ";" + sourceBarcodesDict[destinationWellDict[key].getSampleBarcode()].getRackPos() + ";;" + volume.ToString("R", CultureInfo.InvariantCulture) + ";DNA slow dispense;;" + Convert.ToInt16(Math.Pow(2, tip)) + ";;;");
                                }
                                else
                                {
                                    streamWriter.WriteLine("A;" + sourceLabwareName + ";;" + sourceLabwareType + ";" + sourceBarcodesDict[destinationWellDict[key].getSampleBarcode()].getRackPos() + ";;" + volume.ToString("R", CultureInfo.InvariantCulture) + ";DNA slow dispense;;" + Convert.ToInt16(Math.Pow(2, tip)) + ";;;");
                                }
                                streamWriter.WriteLine("D;PCR96well;;96 well PCR in Metalladapter;" + RackPosTo96wellNumber(key) + ";;" + volume.ToString("R", CultureInfo.InvariantCulture) + ";DNA slow dispense;;" + Convert.ToInt16(Math.Pow(2, tip)) + ";;;");
                            }
                            else
                            {
                                double readwriteVolume = volume;
